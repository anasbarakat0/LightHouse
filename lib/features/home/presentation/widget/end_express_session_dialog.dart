...
void endExpressSessionDialog(BuildContext context, Body sessionData) {
  showDialog(
    context: context,
                    ...
                    "${sessionData.buffetInvoicePrice.toString()} ${"s.p".tr()}",
                      ...
                      if (sessionData.buffetInvoices.isNotEmpty)
                        ...sessionData.buffetInvoices.map((invoice) {
                          // Handle buffet invoices if they are maps
                          if (invoice is Map<String, dynamic>) {
                            final orders = invoice['orders'] as List<dynamic>? ?? [];
                            return Padding(
