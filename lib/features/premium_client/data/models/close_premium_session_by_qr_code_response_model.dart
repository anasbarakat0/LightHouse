...
class ClosePremiumSessionByQrCodeResponseModel {
  final String message;
  final String status;
  final String localDateTime;
  final Body body;

  ClosePremiumSessionByQrCodeResponseModel({
  ...
  ClosePremiumSessionByQrCodeResponseModel copyWith({
    String? message,
    String? status,
    String? localDateTime,
    Body? body,
  }) {
    return ClosePremiumSessionByQrCodeResponseModel(
  ...
  factory ClosePremiumSessionByQrCodeResponseModel.fromMap(
  ...
  factory ClosePremiumSessionByQrCodeResponseModel.fromJson(String source) =>
      ClosePremiumSessionByQrCodeResponseModel.fromMap(
          json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'ClosePremiumSessionByQrCodeResponseModel(message: $message, status: $status, localDateTime: $localDateTime, body: $body)';
  }

  @override
  bool operator ==(covariant ClosePremiumSessionByQrCodeResponseModel other) {
